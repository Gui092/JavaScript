...
const [veiculoA, veiculoB, veiculoC, veiculoD, veiculoE] = myList;

console.log(veiculoA, veiculoB, veiculoC, veiculoD, veiculoE);

// 27 - JSON
const myJson = '{"name": "Guilherme", "age": 33, "skills": ["Phython", "JavaScript", "HTML/CSS"]}';
...
// JSON inválido
const badJson = '{"name": Guilherme, "age": 33}'; // A string do nome está sem aspas
